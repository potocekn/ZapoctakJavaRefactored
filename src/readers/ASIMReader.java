...
public class ASIMReader extends AbstractReader {
    ...
    public AsimData readASIMFile() throws IOException, WrongDataFormatException {
        ...
        try(BufferedReader reader = new BufferedReader(new FileReader(fileName)))
        {
            ...
            {
                throw new WrongDataFormatException("Missing empty line at the bottom of asim file.");
            }
            catch (IndexOutOfBoundsException e)
            {
                throw new WrongDataFormatException("Wrong format of empty line in asim file.");
            }
